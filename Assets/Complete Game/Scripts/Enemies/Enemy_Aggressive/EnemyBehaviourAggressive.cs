...
public class EnemyBehaviourAggressive : MonoBehaviour {

	EnemyAttackAggressive enemyAttack;
	...
	void Start () 
	{
		...
		enemyAttack = GetComponent<EnemyAttackAggressive>();
	...
	void Attack ()
	{
		...
		{
			StartCoroutine(enemyAttack.isShoot());
		}
	}
